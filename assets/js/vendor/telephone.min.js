...
! function(a) {
    ...
    a(b).load(function() {
        ...
        _loadAutoCountry: function() {
            if (a.fn[f].loadedAutoCountry) this.autoCountryDeferred.resolve();
            else {
                a.fn[f].loadedAutoCountry = !0;
                var b = "//ipinfo.io";
                this.b.i && (b += "?token=" + this.b.i), a.get(b, function() {}, "jsonp").always(function(b) {
                    var c = b && b.country ? b.country.toLowerCase() : "";
                    a(".intl-tel-input input").intlTelInput("autoCountryLoaded", c)
                })
            }
        },
        _j: function() {
        ...
        autoCountryLoaded: function(a) {
            "auto" == this.b.d && (this.b.d = a, this._h(), this.autoCountryDeferred.resolve())
        },
        destroy: function() {
