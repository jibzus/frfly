$(function(e) {
    ...
    generateBirthdayPicker = function(n, s) {
        var o = e("<fieldset class='birthdayPicker'></fieldset>"),
            u = e("<select class='form-control birthYear " + s.sizeClass + "' name='birth[year]'></select>"),
            a = e("<select class='form-control birthMonth " + s.sizeClass + "' name='birth[month]'></select>"),
            f = e("<select class='form-control no-margin-right birthDate " + s.sizeClass + "' name='birth[day]'></select>");
